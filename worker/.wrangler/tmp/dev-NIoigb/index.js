...
// .wrangler/tmp/bundle-U4IRVK/strip-cf-connecting-ip-header.js
...
function setCookie(name, value, url, maxAgeSec) {
  const attrs = [
    `${name}=${value}`,
    "Path=/",
    "HttpOnly",
...
app.post("/api/admin/login", async (c) => {
  ...
  const cookieValue = setCookie("admint", token, url, ttl);
...
app.post("/api/admin/logout", async (c) => {
  ...
  const cookieValue = setCookie("admint", "deleted", url, 1);
...
// .wrangler/tmp/bundle-U4IRVK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-U4IRVK/middleware-loader.entry.ts
