...
function build() {
  ...
  const pageFiles = {
    ...
    '/pilates-reformer-monterrey': 'src/pages/PilatesReformerMonterrey.tsx',
    '/packs/monterrey': 'src/pages/PilatesReformerMonterrey.tsx',
  ...
  const urls = [
    ...
    { loc: `${origin}/cama-de-pilates`, lastmod: page('/cama-de-pilates'), changefreq: 'daily', priority: '1.0' },
    ...
    { loc: `${origin}/pilates-reformer-monterrey`, lastmod: page('/pilates-reformer-monterrey'), changefreq: 'weekly', priority: '0.9' },
    { loc: `${origin}/packs/monterrey`, lastmod: page('/packs/monterrey'), changefreq: 'weekly', priority: '0.9' },
    ...
    { loc: `${origin}/certificacion-pilates/queretaro`, lastmod: now, changefreq: 'weekly', priority: '0.7' },
    ...
    { loc: `${origin}/certificacion-pilates/puerto-vallarta`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
    { loc: `${origin}/certificacion-pilates/tijuana`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
    { loc: `${origin}/certificacion-pilates/riviera-maya`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
    { loc: `${origin}/certificacion-pilates/leon`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
    { loc: `${origin}/certificacion-pilates/merida`, lastmod: now, changefreq: 'weekly', priority: '0.6' },
