...
export const upload = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    return await ctx.runMutation(internal.aiImages.uploadInternal as any, body as any);
  },
});
...
export const markForGeneration = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.runMutation(internal.aiImages.markForGenerationInternal as any, {
...
export const updateGeneratedImage = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!authed) return { success: false, error: 'Not authenticated' };
    const { token: _token, ...body } = args;
    await ctx.runMutation(internal.aiImages.updateGeneratedImageInternal as any, body as any);
    return { success: true };
  },
});
...
export const markGenerationFailed = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!authed) return { success: false, error: 'Not authenticated' };
    const { token: _token, ...body } = args;
    await ctx.runMutation(internal.aiImages.markGenerationFailedInternal as any, body as any);
    return { success: true };
  },
});
...
/**
 * INTERNAL: Upload AI image record (used by internal generation pipelines)
 */
export const uploadInternal = internalMutation({
  args: {
    fileName: v.string(),
    storageId: v.id('_storage'),
    mimeType: v.string(),
...
export const markForGenerationInternal = internalMutation({
  args: { imageId: v.id('ai_images') },
  handler: async (ctx, args) => {
    await ctx.db.patch(args.imageId, {
...
export const updateGeneratedImageInternal = internalMutation({
  args: {
    imageId: v.id('ai_images'),
    generatedStorageId: v.id('_storage'),
    generationPrompt: v.string(),
